...
<html lang="en">
    ...
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed" style="">
                                ...
                                <div class="col-lg-12 col-xl-12 ">
                                    <div class="kt-portlet">
                                        ...
                                        <div class="kt-portlet__head">
                                            ...
                                            <?php echo form_open_multipart('seller-send-money-to-bank-form-remit', 'class="kt-form"',$hidden);?>
                                            <?php }?>

                                            <?php if($type=="uto"){ ?>
                                            <?php $hidden=['type'=>$type];?>
                                            <?php echo form_open_multipart('SellerRazorPayPayment/createOrderRemit', 'class="kt-form"',$hidden);?>
                                            <?php }?>
        ...
        $( "#mode" ).change(function() {
            var gid = $(this).val(); 
            if(gid=="tou"){
                window.location.replace("<?= base_url('Seller/remit_type/tou');?>");
            }else if(gid=="uto"){
                window.location.replace("<?= base_url('Seller/remit_type/uto');?>");
            }else if(gid=="tot"){
                window.location.replace("<?= base_url('Seller/remit_type/tot');?>");
            }
        });

                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xl-12 ">
                                    <div class="kt-portlet">
                                        ...
                                        <?php if($type=="remit"){?>
                                            <?php echo form_open_multipart('seller-send-money-to-bank-form-remit', 'class="kt-form"');?>
                                        <?php }?> 
                                        <?php if($type=="own"){?>
                                            <?php echo form_open_multipart('seller-send-money-to-bank-form-own', 'class="kt-form"');?>
                                        <?php }?>
                                        <?php if($type=="request"){?>
                                            <?php echo form_open_multipart('seller-send-money-to-bank-form-request', 'class="kt-form"');?>
                                        <?php }?>      
                                                ...
                                                <?php if($type!="request"){ ?>
                                                    ...
                                                    <div id="special" class="kt-portlet__foot">
                                                        <div class="kt-form__actions">
                                                            <a href="<?= base_url('seller-travpay-add-money');?>" class="btn btn-primary">Add money to wallet</a>
                                                        </div>
                                                    </div>
                                                <?php }?>
                                                <?php if($type=="request"){ ?>

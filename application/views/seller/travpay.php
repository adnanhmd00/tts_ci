                            ...
                            <div class="kt-container  kt-container--fluid ">
                                ...
                                <div class="kt-subheader__toolbar">
                                    <div class="kt-subheader__wrapper">
                                        <a href="<?= base_url('seller-wallet-transactions/accounts');?>" class="btn kt-subheader__btn-primary">
                                            Accounts
                                        </a>
                                        <a href="<?= base_url('seller-wallet-transactions/transactions');?>" class="btn kt-subheader__btn-primary">
                                            Transactions
                                        </a>
                                    </div>
                                </div>
                                        ...
                                        <div class="kt-portlet__body">
                                            <div class="kt-callout__body">
                                                ...
                                                <div class="kt-callout__action">
                                                    <a href="<?= base_url('seller-travpay-add-money');?>" class="btn btn-custom btn-bold btn-upper btn-font-sm  btn-brand">Add Money</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="kt-portlet kt-callout">
                                        <div class="kt-portlet__body">
                                            <div class="kt-callout__body">
                                                ...
                                                <div class="kt-callout__action">
                                                    <a href="<?= base_url('seller-send-money-to-bank/own');?>" class="btn btn-custom btn-bold btn-upper btn-font-sm  btn-success">Send Money</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

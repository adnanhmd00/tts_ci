                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Verification Form</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xl-12">
                                    <div class="kt-portlet">
                                        ...
                                        <form class="kt-form kt-form--label-right" method="post" action="<?= base_url('seller-agent-request-verification-form');?>">
											<div class="kt-portlet__body">
												<div class="form-group row form-group-marginless kt-margin-t-20">
                                                    <div class="col-md-12"><p><?php echo $this->session->flashdata('item'); ?></p></div>

                                                    <!-- <label class="col-lg-1 col-form-label">Company Name: </label>
													<div class="col-lg-3">
														<input type="email" class="form-control" placeholder="Company Name">
														<span class="form-text text-muted">Please Enter Full Name of The Company</span>
													</div> -->
											...
											<div class="kt-portlet__foot">
												<div class="kt-form__actions">
													<div class="row">
														...
														<div class="col-lg-7">
															<button type="submit" class="btn btn-brand">Submit Details</button>

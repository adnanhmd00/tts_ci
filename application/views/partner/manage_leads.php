						...
						<div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="alert alert-light alert-elevate" role="alert">
								...
								<div class="alert-text">
									<a href="<?= base_url('partner-manage-leads');?>">	
										...
										<div class="col-sm">
											<div class="row">
												<div class="col-md-12 mt-15">
													<label>Upload Bulk Leads <a href="<?= base_url('Partner/downloadLeadSample');?>">(Download Sample)</a></label>
							...
							<div class="kt-portlet kt-portlet--mobile">
								<div class="kt-portlet__head kt-portlet__head--lg">
									...
									<div class="kt-portlet__head-toolbar">
										...
										<?php if($id==1){ ?>
											<a href="<?= base_url('partner-purchase-leads');?>" class="btn btn-clean btn-icon-sm">
											<i class="la la-long-arrow-left"></i>
											Purchase Leads
											</a>
										<?php }?>
										<?php if($id==0){ ?>
											<a href="<?= base_url('partner-manage-leads');?>" class="btn btn-clean btn-icon-sm">
											<i class="la la-long-arrow-left"></i>
											Manage Leads
											</a>
										<?php }?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
														...
														<td>
															...
															<?php echo form_open_multipart('partner-buy', '',$hidden);?>

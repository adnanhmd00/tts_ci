...
; display:none!important; position:fixed;width:100%; bottom:0px;">
            ...
            <script type="text/javascript">
				...
				$('#button_div').click(function(e) {
					...
					if (rows != undefined) {
					rowid = rows.attr('id')	
					travel_date = $('#'+rowid+'_travel_date').val();
					return_date = $('#'+rowid+'_return_date').val();
					journey_type = $('#'+rowid+'_journey_type').val();
					...
					flight_name_1 = $('#'+rowid+'_flight_name').val();
					...
					if (rows2 != undefined) {
						...
						if(rowid2){
							...
							flight_name_2 = $('#'+rowid2+'_flight_name').val();

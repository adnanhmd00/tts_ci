			...
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
                ...
                <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                      ...
                      Choose Any One Option To Update The Information
										</h3>
									</div>
                    ...
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="home_screen_background"  value="home_screen_background">
                        <button type="submit" class="btn btn-primary">Home Screen Background</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="vacations_by_theme"  value="vacations_by_theme">
                        <button type="submit" class="btn btn-warning">Vacations By Theme</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="trending_destinations"  value="trending_destinations">
                        <button type="submit" class="btn btn-danger">Trending Destinations</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="unexplored_destinations"  value="unexplored_destinations">
                        <button type="submit" class="btn btn-info">Unexplored Destinations</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="message_box_upper_inspiration"  value="message_box_upper_inspiration">
                        <button type="submit" class="btn btn-success">Message Box Upper Inspiration</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="message_box_lower_inspiration"  value="message_box_lower_inspiration">
                        <button type="submit" class="btn btn-warning">Message Box Lower Inspiration</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="trending_experience"  value="trending_experience">
                        <button type="submit" class="btn btn-danger">Trending Experience</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="best_offer_and_deals"  value="best_offer_and_deals">
                        <button type="submit" class="btn btn-info">Best Offer & Deals</button>
                      </form>
                    </div>
                    <div class="form-group">
                      <form class="form-group" action="flight-app-image" method="POST">
                        <input type="hidden" name="video_box"  value="video_box">
                        <button type="submit" class="btn btn-success">Video Box</button>
                      </form>
                    </div>

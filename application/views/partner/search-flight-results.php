						...
						foreach ($response_onward as $Result) { 
							...
							<td>
								...
								<?php
								 ...
								 $four_AdultBasefare = $AdultBasefare*8/100;
								 ...
								 if($ChildCount > 0){
									...
									$four_ChildBasefare = $ChildBasefare*8/100;
								 ...
								 if($InfantCount > 0){
									...
									$four_InfantBasefare = $InfantBasefare*8/100;
						...
						foreach ($response_return as $Result) { 
							...
							<td>
								...
								<td>
									<div class="text-center mt-4">
										<div id="flight-price" class="h5"><?php echo round($finalPrice,0); ?>/-
										<input type="hidden" id="two_way_<?php echo $i; ?>_basefare" value="<?php echo round($finalBasefare,0); ?>">
										<input type="hidden" id="two_way_<?php echo $i; ?>_tax" value="<?php echo round($finalTaxfare,0); ?>">
										</div>
									</div>
								</td>

                        ...
                        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="alert alert-light alert-elevate" role="alert">
								<div class="alert-text">
									...
									In Case the Third Party Unknown Travel Agent is Also Registered with us, the <b>Transaction can be Processed Via us to Safegaurd
									and Gaurantee the Terms & Conditions of the Booking and Payment</b> is Safe for the Duration of Booking.
                                </div>
							</div>

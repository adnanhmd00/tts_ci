...
<!--begin::Fonts -->
<link rel="stylesheet" href="<?= base_url('resource/admin/files/css');?>">
<!--end::Fonts -->

<!--begin::Page Custom Styles(used by this page) -->
<link href="<?= base_url('resource/admin/files/login-1.css');?>" rel="stylesheet" type="text/css">
<!--end::Page Custom Styles -->
<link href="<?php base_url('resource/admin/file/pricing-2.css');?>" rel="stylesheet" type="text/css">

<!--begin::Global Theme Styles(used by all pages) -->
<link href="<?= base_url('resource/admin/files/plugins.bundle.css');?>" rel="stylesheet" type="text/css">
<link href="<?= base_url('resource/admin/files/style.bundle.css');?>" rel="stylesheet" type="text/css">
<!--end::Global Theme Styles -->

            <!--begin::Page Vendors Styles(used by this page) -->
<link href="<?= base_url('resource/admin/files/fullcalendar.bundle.css');?>" rel="stylesheet" type="text/css">
...
<link href="<?= base_url('resource/admin/files/dark.css');?>" rel="stylesheet" type="text/css">
<link href="<?= base_url('resource/admin/files/dark(1).css');?>" rel="stylesheet" type="text/css">
...
<script async="" src="<?= base_url('resource/admin/files/modules.3a2c212c6000288ee2ae.js.download');?>" charset="utf-8"></script>
<style type="text/css">
...
</style><script type="text/javascript" charset="UTF-8" src="./files/common.js.download"></script><script type="text/javascript" charset="UTF-8" src="<?= base_url('resource/admin/files/util.js.download');?>"></script>
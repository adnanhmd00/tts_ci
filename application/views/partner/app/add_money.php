                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Recharge TravPay Wallet</h3>
                        ...
                        <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
							...
							<div class="alert alert-light alert-elevate" role="alert">
								<div class="alert-text">
                                    TravPay is an Integrated Travel Wallet System & Payment Gateway in The Travel Square Platform For Making All Types of Payments Via Credit/Amex/Debit
									Cards, UPI, Bank NEFT/IMPS/RTGS, Outward Remmitances, Inward Remmitances, Crypto Transactions and More. Powered By <a href="http://instawiremoney.com/">Instawire</a> and
									Rate of Exchange Monitored Via <a href="https://www.xe.com/">xe.com</a> and <a href="http://instawireforex.com/">Instawire Forex</a>
                                </div>
							</div>
                            <!--Begin::Dashboard 1-->
                            <!--Begin::Row-->
                                ...
                                <div class="col-lg-12 col-xl-12 ">
                                    <div class="kt-portlet">
                                        ...
                                        <div class="kt-portlet__head">
                                            <div class="kt-portlet__head-label">
                                                <h3 class="kt-portlet__head-title">
                                                    Wallet Balance : <?= $currency;?> <?= $wallet_balance;?>
                                                </h3>
                                            </div>
                                        </div>
                                        ...
                                        <!--begin::Form-->
                                        <?php echo form_open_multipart('rzp-add-money', 'class="kt-form"');?>
                                                    ...
                                                    <div class="form-group">
														...
														<select name="currency_id" class="form-control">
                                                            <?php foreach($allCurrency as $row){ ?>
                                                                <?php if($userinfo->currency==$row->id){ ?>

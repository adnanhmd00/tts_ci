...
<html lang="en">
    ...
    <body class="kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--fixed kt-header-mobile--fixed kt-subheader--enabled kt-subheader--fixed kt-subheader--solid kt-aside--enabled kt-aside--fixed" style="">
                                    ...
                                    <form>
                                        ...
                                        <div class="kt-head kt-head--skin-dark kt-head--fit-x kt-head--fit-b" style="background-image: url(http://partner.thetravelsquare.in/uploads/b2b/black-banner.png)">
                                            ...
                                            <ul class="nav nav-tabs nav-tabs-line nav-tabs-bold nav-tabs-line-3x nav-tabs-line-success kt-notification-item-padding-x" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link active show" data-toggle="tab" href="http://partner.thetravelsquare.in/#topbar_notifications_notifications" role="tab" aria-selected="true">Alerts</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="http://partner.thetravelsquare.in/#topbar_notifications_events" role="tab" aria-selected="false">Events</a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link" data-toggle="tab" href="http://partner.thetravelsquare.in/#topbar_notifications_logs" role="tab" aria-selected="false">Logs</a>
                                                </li>
                                            </ul>
                                        </div>
                                        <!--end: Head -->
                                    ...
                                    <form>
                                        ...
                                        <div class="kt-grid-nav kt-grid-nav--skin-light">
                                            <div class="kt-grid-nav__row">
                                                <a href="http://partner.thetravelsquare.in/#" class="kt-grid-nav__item">
                                            ...
                                            <div class="kt-mycart__body kt-scroll ps" data-scroll="true" data-height="245" data-mobile-height="200" style="height: 245px; overflow: hidden;">
                                                <div class="kt-mycart__item">
                                                    <div class="kt-mycart__container">
                                                        <div class="kt-mycart__info">
                                                            <a href="http://partner.thetravelsquare.in/#" class="kt-mycart__title">
                                                            Samsung
                                                            </a>
                                                            ...
                                                            <div class="kt-mycart__action">
                                                                ...
                                                                <a href="http://partner.thetravelsquare.in/#" class="btn btn-label-success btn-icon">−</a>
                                                                <a href="http://partner.thetravelsquare.in/#" class="btn btn-label-success btn-icon">+</a>
                                                            </div>
                                                        </div>
                                                        <a href="http://partner.thetravelsquare.in/#" class="kt-mycart__pic">
                                ...
                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround">
                                    <ul class="kt-nav kt-margin-t-10 kt-margin-b-10">
                                        <li class="kt-nav__item kt-nav__item--active">
                                            <a href="http://partner.thetravelsquare.in/#" class="kt-nav__link">
                                ...
                                <div class="col-lg-12 col-xl-12 ">
                                    <div class="kt-portlet">
                                        ...
                                        <div class="kt-portlet__head">
                                            ...
                                            <?php if($type=="tot" || $type=="tou"){ ?>
                                            <?php $hidden=['type'=>$type];?>
                                            <?php echo form_open_multipart('send-money-to-bank-form-remit', 'class="kt-form"',$hidden);?>
                                            <?php }?>

                                            <?php if($type=="uto"){ ?>
                                            <?php $hidden=['type'=>$type];?>
                                            <?php echo form_open_multipart('RazorPayPayment/createOrderRemit', 'class="kt-form"',$hidden);?>
                                            <?php }?>
                                            <div class="kt-portlet__body">
                                                    ...
                                                    <div class="kt-section kt-section--first">
                                                        ...
                                                        <?php if($type=="remit"){?>
                                                            ...
                                                            <div class="form-group">
                                                                <select class="form-control" id="mode" required name="mode"> 
                                                                    <option value="">-Choose-</option>
                                                                    <option value="tou">TRAVPAY TO OTHER USER ACCOUNT</option>
                                                                    <option value="uto">YOUR ACCOUNT TO OTHER USER ACCOUNT</option>
                                                                    <option value="tot">TRAVPAY TO OTHER TRAVPAY</option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <?php if($type=="tou"){?>
                                                            <div id="otheruseraccount">
                                                                <div class="form-group">
                                                                    <input type="number" required id="amount" class="form-control" placeholder="Amount" required name="amount">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" required class="form-control" placeholder="Account Holder Name"  name="achn">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="number" required class="form-control" placeholder="Account Number"  name="acno">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" required class="form-control" placeholder="IFSC" name="ifsc">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" required class="form-control" placeholder="Bank Name"  name="bankname">
                                                                </div>
                                                            </div> 
                                                        <?php }?>
                                                        <?php if($type=="uto"){?>
                                                        ...
                                                        <?php if($type=='tot'){ ?>
                                                            <div id="phonenumber">
                                                                <div class="form-group">
                                                                    <input type="number" id="amount" class="form-control" required placeholder="Amount" required name="amount">
                                                                </div>
                                                                <div class="form-group">
                                                                    <input type="text" class="form-control" placeholder="Trav Pay Id" required name="trav_pay_id">
                                                                </div>
                                                            </div>
                                                        <?php }?>
                                                ...
                                                <?php if($type=="tou" || $type=="uto" || $type=="tot"){ ?>
        ...
        $( "#mode" ).change(function() {
            var gid = $(this).val(); 
            if(gid=="tou"){
                window.location.replace("<?= base_url('Partner/remit_type/tou');?>");
            }else if(gid=="uto"){
                window.location.replace("<?= base_url('Partner/remit_type/uto');?>");
            }else if(gid=="tot"){
                window.location.replace("<?= base_url('Partner/remit_type/tot');?>");
            }
        });

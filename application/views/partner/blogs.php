...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('resource/blogs/slick/slick.css');?>">
	<link rel="stylesheet" type="text/css" href="<?= base_url('resource/blogs/slick/slick-theme.css');?>">
    <link rel="stylesheet" href="<?= base_url('resource/blogs/style.css');?>">
       ...
       <div class="container">
           ...
           <div class="row">
               <div class="col-md-8 mb-2">
                   ...
                   <div class="overlay">
                       <h3 class="overlay-text"><?= $data[0]->headline;?></h3>
                       <p class="overlay-para"><strong><?= $data[0]->tagline;?></strong></p>
                       <a target="_blank" href="<?= base_url('show-blog/'.$data[0]->id);?>" class="btn btn-outline-light overlay-button">Explore More</a>
                   </div>
               </div>
               <div class="col-md-4">
                  <div class="card">
                        <a style="color:white;" target="_blank" href="<?= base_url('show-blog/'.$data[1]->id);?>">
                            <div class="card-img">
                                <img style="width: 100%; height: 180px;" src="<?= $data[1]->image;?>" alt="" class="img-fluid">
                                <div class="card-img-overlay">
                                    <i class="fa fa-map-marker"></i> &nbsp;<?= $data[1]->headline;?>
                                </div>
                            </div>
                            <div class="card-body">
           ...
           <div class="row mt-3">
               ...
               <div class="col-md-4 mb-2">
                <div class="card">
                    <a style="color:white;" href="<?= base_url('show-blog/'.$data[$i]->id);?>">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <iframe width="100%" height="530" src="https://www.youtube.com/embed/tVHSTtQfbAI" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
    </div>
</div>

                                ...
                                <div class="col-md-4  mt-3 rounded">
                                    <a href="/experience-detail/<?php echo $experience['id'] ?>">
                                        <div style="border-radius: 12px !important;" class="card">
                                            <img style="border-radius: 12px 12px 0px 0px !important;" style="width: 270px; height: 180px;" src="<?php echo json_decode($experience['photos_of_experience'])[0] ?>" alt="" class="img-fluid">
                                            <div class="mx-2 my-2">

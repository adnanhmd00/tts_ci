                            ...
                            <div class="kt-header__topbar-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-fit dropdown-menu-right dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                                    <form>
                                        <!-- begin:: Mycart -->
                                        <div class="kt-mycart">
                                            <div class="kt-mycart__head kt-head" style="background-image: url(./img/black-wallpaper.png);">
                                            ...
                                            <div class="kt-mycart__body kt-scroll ps" data-scroll="true" data-height="245" data-mobile-height="200" style="height: 245px; overflow: hidden;">
                                                <div class="kt-mycart__item">
                                                    <div class="kt-mycart__container">
                                                        <div class="kt-mycart__info">
                                                            <a href="http://supplier.thetravelsquare.in/" class="kt-mycart__title">
                                                            Dubai Package                       
                                                            </a>
                                                            <span class="kt-mycart__desc">
                                                            Package Code : TSP132CPI
                                                            </span>
                                                            <div class="kt-mycart__action">
                                                                <span class="kt-mycart__price">$ 1450</span>
                                                                <span class="kt-mycart__text">for</span>
                                                                <span class="kt-mycart__quantity">3 PAX</span>
                                                                <a href="http://supplier.thetravelsquare.in/" class="btn btn-label-success btn-icon">−</a>
                                                                <a href="http://supplier.thetravelsquare.in/" class="btn btn-label-success btn-icon">+</a>
                                                            </div>
                                                        </div>
                                                        <a href="http://supplier.thetravelsquare.in/" class="kt-mycart__pic">
                                                ...
                                                <div class="kt-mycart__item">
                                                    <div class="kt-mycart__container">
                                                        <div class="kt-mycart__info">
                                                            ...
                                                            <span class="kt-mycart__desc">
                                                            Dubai Tourist Visa : TSV12I
                                                            </span>
                                                            <div class="kt-mycart__action">
                                                                <span class="kt-mycart__price">$ 240</span>
                                                                <span class="kt-mycart__text">for</span>
                                                                <span class="kt-mycart__quantity">3 PAX</span>
                                                                <a href="http://supplier.thetravelsquare.in/" class="btn btn-label-success btn-icon">−</a>
                                                                <a href="http://supplier.thetravelsquare.in/" class="btn btn-label-success btn-icon">+</a>                          
                                                ...
                                                <div class="kt-mycart__item">
                                                    <div class="kt-mycart__container">
                                                        <div class="kt-mycart__info">
                                                            ...
                                                            <div class="kt-mycart__action">
                                                                <span class="kt-mycart__price">$ 2310</span>
                                                                <span class="kt-mycart__text">for</span>
                                                                <span class="kt-mycart__quantity">3 PAX</span>
                                                                <a href="http://supplier.thetravelsquare.in/" class="btn btn-label-success btn-icon">−</a>
                                                                <a href="http://supplier.thetravelsquare.in/" class="btn btn-label-success btn-icon">+</a>
                                            ...
                                            <div class="kt-mycart__footer">
                                                <div class="kt-mycart__section">
                                                    ...
                                                    <div class="kt-mycart__prices">
                                                        <span>$ 3840.31</span> 
                                                        <span>$ 260.20</span> 
                                                        <span class="kt-font-brand">$ 4000.51</span>
                                                    </div>
                                                </div>
                                                <div class="kt-mycart__button kt-align-right">
                                                    <button type="button" class="btn btn-primary btn-sm">Make Payment</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end:: Mycart -->        
                                    ...
                                    <div class="kt-notification">
                                        ...
                                        <a href="https://keenthemes.com/metronic/preview/demo1/custom/apps/user/profile-3.html" class="kt-notification__item">
                                            ...
                                            <div class="kt-notification__item-details">
                                                ...
                                                <div class="kt-notification__item-time">
                                                    Deals Purchased or Bookings Done By You
                                                </div>
                                            </div>
                                        </a>
                                        <div class="kt-notification__custom kt-space-between">
                                            <a href="#" target="_blank" class="btn btn-label btn-label-brand btn-sm btn-bold">LOG OUT</a>
                                            <a href="#" target="_blank" class="btn btn-clean btn-sm btn-bold">Premium Seller</a>
                                        </div>
                                    </div>
                                    <!--end: Navigation -->
                                </div>

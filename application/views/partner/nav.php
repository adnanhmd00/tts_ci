    ...
    <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper" style="background-color:black;">
        <div id="kt_header_menu" style="background-color:black;" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
            <ul class="kt-menu__nav " style="background-color:black;">
                ...
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel" aria-haspopup="true">
                    <a href="<?= base_url('/Partner/view_booking_details');?>" class="kt-menu__link">
                            <span class="kt-header__link-icon">
								<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
								<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
									<rect x="0" y="0" width="24" height="24"/>
                        ...
                        <span class="kt-menu__link-text">Bookings</span><i class="kt-menu__ver-arrow la la-angle-right"></i>
                    </a>
                </li>
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel">
                        ...
                        <div class="kt-grid-nav__row">
                            <a href="http://partner.thetravelsquare.in/wallet-transactions/invoice" class="kt-grid-nav__item">
                                <span class="kt-grid-nav__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="kt-svg-icon kt-svg-icon--dark kt-svg-icon--lg">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                            <rect x="0" y="0" width="24" height="24"></rect>
                                        ...
                                        <div class="kt-mycart">
                                            ...
                                            <div class="kt-mycart__footer">
                                                <div class="kt-mycart__button kt-align-right">
                                                    <button type="button" class="btn btn-dark btn-sm">Make Payment</button>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- end:: Mycart -->        

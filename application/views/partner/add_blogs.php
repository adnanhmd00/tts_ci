...
<title><?php if(!empty($userinfo)){ echo ucwords($userinfo->type);} ?> Write Travel Blogs | Partner Login | The Travel Square | India's Largest B2B Travel Network Company Platform</title>


<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
<meta name="author" content="Business The Travel Square">
<meta name="description" content="Write Travel Blogs with Travel Information and Experience | Partner Login | The Travel Square | India's Largest B2B Travel Network Company Platform">
...
<meta property="og:title" content="Write Travel Blogs | Partner Login | The Travel Square | India's Largest B2B Travel Network Company">
...
<meta property="og:description"
    content="Write Travel Blogs with Travel Information and Experience | Partner Login | The Travel Square | India's Largest B2B Travel Network Company Platform">

<meta name="twitter:title" content="Write Travel Blogs | Partner Login | The Travel Square | India's Largest B2B Travel Network Company">
                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Write Travel Blogs</h3>
                                        ...
                                        <div class="kt-portlet__head">
                                            <div class="kt-portlet__head-label">
                                                <h3 class="kt-portlet__head-title">
                                                    Add Your Travel Related Blogs & Promotions Here to Be Published on The Travel Square
                                                </h3>
                                            </div>
                                        </div>
                                        <!--begin::Form-->
                                        <?php $hidden = ['user_type' => $userinfo->type, 'user_id' => $userinfo->id];?>

                                        <?php echo form_open_multipart('add/blog', 'class="kt-form"');?>
                                                ...
                                                <div class="kt-section kt-section--first">
                                                    <div class="form-group">
                                                        ...
                                                        <!-- <div class="tinymce-wrap">
                                                            <textarea class="tinymce" name="blog" placeholder="Cancelation Policy"></textarea>
                                                        </div> -->
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Tagline</label>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <!-- <div class="tinymce-wrap">
                                                            <textarea class="tinymce" name="blog" placeholder="Blogs"></textarea>
                                                        </div> -->
                                                        <!-- <textarea class="form-control" name="cancelation_policy" placeholder="Cancelation Policy"></textarea> -->
                                                    </div>
                                                    <div class="form-group">
                                                        <label>Upload Images</label>
                                                        <input type="file" name="image[]" multiple="multiple" required class="form-control"/>
                                                    </div>

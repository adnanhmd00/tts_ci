        ...
        <div class="kt-portlet__body kt-portlet__body">
            ...
            <div id="sub_datatable_ajax_source" class="kt-datatable kt-datatable--default kt-datatable--brand kt-datatable--loaded">
                ...
                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 10; width: 90%; background-color:white;">
                    ...
                    <tbody>
                        <?php foreach($data as $ifd){
							?>
                        <tr>
							<td><?php echo $ifd->fd_id; ?></td>
                            <td><?php echo $ifd->sector; ?></td>
                            <td><?php echo $ifd->departure_date; ?></td>
                            <td><?php echo $ifd->arrival_date; ?></td>
                            <td><?php echo $ifd->fare_type; ?></td>
                            <td><?php echo $ifd->departure_time; ?></td>
                            <td><?php echo $ifd->arrival_time; ?></td>
                            <td><?php echo $ifd->adult_fare; ?></td>

...
<html lang="en">
    ...
    <!-- end::Head -->
		...
		<title>Cancellation and Refund Request Form | Partner Login | The Travel Square | India's Largest B2B Travel Network Company</title>
		
		<!-- Meta Tags -->
		<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<meta name="author" content="The Travel Square">
		<meta name="description" content="Request for your Refund Related Queries, or Booking Cancellation Request with Lesser Deduction. Cancellation and Refund Request Form | Partner Login | The Travel Square | India's Largest B2B Travel Network Company">
		...
		<meta property="og:title" content="Partner Help | Partner Login | The Travel Square | India's Largest B2B Travel Network Company">
		<meta property="og:description" content="Request for your Refund Related Queries, or Booking Cancellation Request with Lesser Deduction. Cancellation and Refund Request Form | Partner Login | The Travel Square | India's Largest B2B Travel Network Company">
		...
		<meta name="twitter:card" content="Request for your Refund Related Queries, or Booking Cancellation Request with Lesser Deduction. Cancellation and Refund Request Form | Partner Login | The Travel Square | India's Largest B2B Travel Network Company">
                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Refund Request and Booking Cancellation Request Form</h3>
                                        ...
                                        <?php echo form_open_multipart('partner-booking-cancellation-form', 'class="kt-form"');?>
                                            ...
                                            <p><?php echo $this->session->flashdata('item'); ?></p>
                                                ...
                                                <div class="kt-section kt-section--first">
                                                    ...
                                                    <div class="form-group">
                                                        <input type="text" class="form-control" placeholder="Service Id" name="service_id">
                                                    </div>

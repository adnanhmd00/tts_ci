                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Edit Deal Dates</h3>
                                    ...
                                    <div class="kt-portlet__head">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 10; width: 100%; background-color:white;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td><?= $row->dates;?></td>
                                                    <td align="center" style="vertical-align: middle;"><a href="<?= base_url('partner/edit/deal/delete/date/'.$row->id.'/'.$id);?>" class="btn btn-danger">X</a></td>
                                                </tr>
                                                <?php }?>
                                            </tbody>
                                        </table>

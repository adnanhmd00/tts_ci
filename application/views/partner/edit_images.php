                    ...
                    <div class="kt-content  kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" id="kt_content">
                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Edit Deal Images | Partner Deal | Deal ID</h3>
						...
						<div class="alert alert-light alert-elevate" role="alert">
								...
								<div class="alert-text">
                                   Update / Change or Modify Your Posted Deal <b>Images and Banners</b> From Here Instanly on The Travel Square Platform.
                                </div>
							</div>
                            <!--Begin::Dashboard 1-->
                            <!--Begin::Row-->
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 10; width: 100%; background-color:white;">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td align="center" style="vertical-align: middle;"><a href="<?= base_url('partner/edit/deal/delete/image/'.$row->id.'/'.$id);?>" class="btn btn-dark">X</a></td>
                                                </tr>
                                                <?php }?>
                                            </tbody>
                                        </table>

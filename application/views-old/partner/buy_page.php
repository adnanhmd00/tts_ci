                        ...
                        <div class="kt-subheader  kt-grid__item" id="kt_subheader">
                            <div class="kt-container  kt-container--fluid ">
                                <div class="kt-subheader__main">
                                    <h3 class="kt-subheader__title">Purchase</h3>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-xl-12 ">
                                    <div class="kt-portlet">
                                        ...
                                        <?php if($wallet_balance < $price){ ?>
                                            <div class="kt-portlet__head">
                                                <div class="kt-portlet__head-label">
                                                    <h3 class="kt-portlet__head-title">
                                                        <a href="<?= base_url('partner-travpay-add-money');?>">Add Money To Wallet</a>
                                                    </h3>
                                                </div>
                                            </div>                                        
                                        <?php }?>
                                        ...
                                        <!--begin::Form-->
                                        <?php if($type=="LEAD"){?>
                                        <?php $leadhidden=['id'=>$id,'price'=>$price];?>
                                        <?php echo form_open_multipart('purchase-lead', 'class="kt-form"',$leadhidden);?>
                                            ...
                                            <p><?php echo $this->session->flashdata('item'); ?></p>
                                                ...
                                                <div class="kt-section kt-section--first">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input readonly type="number" class="form-control" value="<?= $price;?>" placeholder="Amount" required name="amount">
                                                    </div>
                                            ...
                                            <?php if($wallet_balance < $price){ ?>
                                                <div class="kt-portlet__foot">
                                                    <div class="kt-form__actions">
                                                        <a href="<?= base_url('partner-travpay-add-money');?>">Less Amount IN Wallet</a>
                                                    </div>
                                                </div>                                                
                                            <?php }?>
                                            <?php if($wallet_balance >= $price){ ?>

...
class AppExperience extends CI_Controller
{
    public $created_at;
    public $apikey;
    public $userinfo;
    ...
    public function index()
    {
        ...
        $this->load->view('partner/app/experience', compact('userinfo', 'data'));
    }
    ...
    public function experienceList($city){
        ...
        $this->load->view('partner/app/experience-list', compact('data', 'city', 'count'));
    }
    ...
    public function experienceGallery($id){
        ...
        $query = $this->db->query($sql);
        $data = $query->result_array();
        $this->load->view('partner/app/experience-gallery', compact('data'));
    }
}
